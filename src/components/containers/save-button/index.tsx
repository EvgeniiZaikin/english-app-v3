...
const saveButton: FC<IProps> = ({ 
    type, ruValue, category, enValue, create, appTheme, expression, slang, abuse, abbreviation
}) : ReactElement => {
    ...
    const save = () => {
        try {
            create(type, { 
                ruValue, category_label: ruValue, enValue, category,
                expression, slang, abuse, abbreviation,
            });
        } catch (error) {
